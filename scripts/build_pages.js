...
function renderHeader(activeCategory = '') {
  ...
  <div class="top-bar">
    <div class="top-bar__inner">
      <div class="top-bar__links">
        ...
        <a href="#">Примерка и обмен</a>
        <a href="#">Контакты</a>
        <a href="#">Электронные карты для шопинга</a>
      </div>
      <div class="top-bar__right">
        <span onclick="App.openCallback()">0 800 200-745 ⌄</span>
        <span>RU ⌄</span>
        <span onclick="App.showToast('Вход в личный кабинет')">Вход в аккаунт</span>
      </div>
    </div>
  </div>
  ...
  <header class="site-header">
    <div class="header-main">
      <!-- Gender Tabs -->
      <div class="header-gender-tabs">
        <a href="/catalog?cat=zhenskoe-bele" class="gender-tab active">ЖЕНЩИНАМ</a>
        <a href="/catalog?cat=muzhskoe" class="gender-tab">МУЖЧИНАМ</a>
        <a href="/catalog?cat=detskoe" class="gender-tab">ДЕТКАМ</a>
        <a href="/catalog?cat=lux" class="gender-tab">ЛЮКС</a>
      </div>
      ...
      <div class="header-right-group">
        <div class="search-box">
          <div class="search-box__ai-icon">ai</div>
    ...
    <nav class="subnav-bar">
      <div class="subnav-bar__inner">
        <a href="/catalog?cat=zhenskoe-bele" class="subnav-link ${activeCategory === 'zhenskoe-bele' ? 'active' : ''}">Женское белье</a>
        <a href="/catalog?cat=byustgaltery" class="subnav-link ${activeCategory === 'byustgaltery' ? 'active' : ''}">Бюстгальтеры</a>
        <a href="/catalog?cat=trusiki" class="subnav-link ${activeCategory === 'trusiki' ? 'active' : ''}">Трусики</a>
        <a href="/catalog?cat=eroticheskoe" class="subnav-link ${activeCategory === 'eroticheskoe' ? 'active' : ''}">Эротическое белье</a>
        <a href="/catalog?cat=domashnyaya-odezhda" class="subnav-link ${activeCategory === 'domashnyaya-odezhda' ? 'active' : ''}">Домашняя одежда</a>
        <a href="/catalog?cat=termobele" class="subnav-link ${activeCategory === 'termobele' ? 'active' : ''}">Термобельё</a>
        <a href="/catalog?cat=odezhda" class="subnav-link ${activeCategory === 'odezhda' ? 'active' : ''}">Одежда</a>
        <a href="/catalog?cat=kolgotki" class="subnav-link ${activeCategory === 'kolgotki' ? 'active' : ''}">Колготки</a>
        <a href="/catalog?cat=aksessuary" class="subnav-link ${activeCategory === 'aksessuary' ? 'active' : ''}">Аксессуары</a>
        <a href="/catalog?cat=obuv" class="subnav-link ${activeCategory === 'obuv' ? 'active' : ''}">Обувь</a>
        <a href="/catalog?cat=kupalniki" class="subnav-link ${activeCategory === 'kupalniki' ? 'active' : ''}">Купальники</a>
        <a href="/catalog?sale=1" class="subnav-link sale ${activeCategory === 'sale' ? 'active' : ''}">SALE</a>
      </div>
    </nav>
  </header>
  `;
...
<body>
  ...
  <div class="hero-fullwidth-slider" id="heroSlider">
    <div class="hero-slider-track" id="sliderTrack">
      <!-- Slide 1 (Exact image from Screenshot 2: BACK TO OFFICE) -->
      <div class="hero-slide">
        <a href="/catalog?cat=zhenskoe-bele">
          <img class="hero-slide__image" src="https://im1.intimo.com.ua/img/nb/1788170306_img_1_2_7_771_2732x856.jpg" alt="BACK TO OFFICE - Білизна та одяг для нового сезону">
        </a>
      </div>
      ...
      <div class="hero-slide">
        <a href="/catalog?sale=1">
          <img class="hero-slide__image" src="https://im1.intimo.com.ua/img/nb/1786449767_img_1_2_7_768_2732x856.jpg" alt="Распродажа до -60%">
        </a>
      </div>

      <!-- Slide 3 (Коллекция белья) -->
      <div class="hero-slide">
        <a href="/catalog?cat=byustgaltery">
          <img class="hero-slide__image" src="https://im1.intimo.com.ua/img/nb/1788248276_img_1_2_7_772_2732x856.jpg" alt="Новая коллекция нижнего белья">
        </a>
      </div>

      <!-- Slide 4 (Купальники и пляжная одежда) -->
      <div class="hero-slide">
        <a href="/catalog?cat=kupalniki">
          <img class="hero-slide__image" src="https://im1.intimo.com.ua/img/nb/1785938884_img_1_2_7_755_2732x856_5.jpg" alt="Купальники и пляжная одежда">
        </a>
      </div>
    </div>

    <!-- Badge -10% in bottom-left (Screenshot 2) -->
    <a href="/catalog?sale=1" class="hero-slider__badge" title="Скидка -10%">-10%</a>

    <!-- Slider Dots in bottom-right (Screenshot 2) -->
    <div class="hero-slider__dots" id="sliderDots">
